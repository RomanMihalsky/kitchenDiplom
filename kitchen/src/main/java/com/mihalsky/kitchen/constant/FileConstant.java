...
public class FileConstant {
  ...
  public static final String FOOD_IMAGE_PATH = "/food/image/"; 
  public static final String JPG_EXTENSION = "jpg";
  public static final String USER_FOLDER = System.getProperty("user.home") + "/kitchen/user/";
  public static final String FOOD_FOLDER = System.getProperty("user.home") + "/kitchen/food/";
  public static final String DIRECTORY_CREATED = "Created directory for: ";
  public static final String DEFAULT_USER_IMAGE_PATH = "/user/image/profile/";
  public static final String DEFAULT_FOOD_IMAGE_PATH = "/food/image/view/";
