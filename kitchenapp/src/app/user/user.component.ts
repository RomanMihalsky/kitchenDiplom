...
import { FileUploadStatus } from '../model/file-upload';
...
export class UserComponent implements OnInit, OnDestroy {
  private titleSubject = new BehaviorSubject<string>('Пользователи');
    ...
    this.subscriptions.push(
      this.userService.getUsers().subscribe(
        (response: User[]) => {
          ...
          if (showNotification) {
            this.sendNotification(NotificationType.SUCCESS, `Пользователи загружены успешно.`);
          }
        },
